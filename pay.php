...
//else  { $post_url = "http://bentcorner.com/payeezy/dump.php";
}
...
else { $description = "Your Purchase";
}
...
<center><h2>Processing your  $<?php echo $x_amount;?> payment <?php echo $x_first_name;?>, please wait...</h2></center>
